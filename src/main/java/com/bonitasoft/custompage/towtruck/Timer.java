...
import com.bonitasoft.custompage.towtruck.cmdtimer.CmdCreateTimer;
		...
		public static HashMap<String, Object> createMissingTimers(MethodResetTimer methodResetTimer, InputStream inputStreamJarFile, ProcessAPI processAPI, CommandAPI commandAPI, PlatformAPI platformAPI) {
				...
				try {
						...
						if (MethodResetTimer.RetryTask.equals(methodResetTimer)) {
								...
								CommandDescriptor command = deployCommand("TowTruckCreateTimer", "Create timer", "com.bonitasoft.custompage.towtruck.cmdtimer.CmdCreateTimer", inputStreamJarFile, "custompagelongboard", commandAPI, platformAPI);
